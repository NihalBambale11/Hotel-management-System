...
class Hotel
{
    static RoomHolder  hotel_ob=new RoomHolder ();
    static Scanner sc = new Scanner(System.in);
    static HotelData hd = new HotelData();
        static String name;
		static String contact;
		static String gender;
        static String name2 = null;
		static String contact2 = null; 
        static String gender2="";
    static void CustDetails(int i,int rn) throws ClassNotFoundException, SQLException
    {
    ...
    static void bookroom(int i) throws ClassNotFoundException, SQLException
    {
        int j;
        int rn;
    ...
    {
        double amount=0;
        String list[]={"Sandwich","Pasta","Noodles","Coke","Burger","Pizza","Dal Fry","Roti","Rice","Chicken Curry","Chicken Biryani"};   
        System.out.println("\n*******");
    ...
    static void order(int rn,int rtype)
    {
        ...
        char wish;
         try{
             System.out.println("\n==========\n   Menu:  \n==========\n\n1.Sandwich\tRs.50\n2.Pasta\t\tRs.60\n3.Noodles\tRs.70\n4.Coke\t\tRs.30"
             		+ "\n5.Burger\tRs.80\n6.Pizza\t\tRs.200\n7.Dal Fry\tRs.90\n8.Roti\t\tRs.09\n"
             		+ "9.Rice\t\tRs.90\n10.Chicken Curry\tRs.190\n11.Chicken Biryani\tRs.200\n");
        do
        {
            i = sc.nextInt();
